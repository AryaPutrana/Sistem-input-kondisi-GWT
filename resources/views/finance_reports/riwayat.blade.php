...
@section('title', 'Riwayat Input Keuangan')
...
<form method="GET" action="{{ route('keuangan.riwayat') }}" class="row g-2 align-items-end mb-3">
    ...
    <div class="col-auto">
        ...
        <a href="{{ route('keuangan.riwayat') }}" class="btn btn-outline-secondary ms-1">Reset</a>
    </div>
</form>

<div class="alert alert-light border mb-3 d-flex flex-wrap gap-3 align-items-center">
    <span>Total input Anda bulan <strong>{{ $bulanLabel }}</strong>: <span class="badge bg-primary">{{ $total }}</span></span>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted py-4">Belum ada data untuk bulan ini.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
