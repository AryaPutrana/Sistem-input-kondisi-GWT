...
class UpdateFinanceLocationRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'nama_lokasi' => [
                ...
                'string',
                'max:255',
                Rule::unique('finance_locations', 'nama_lokasi')->ignore($this->route('lokasiBulanan')),
            ],
            'keterangan' => ['nullable', 'string'],
            'status' => ['required', Rule::in(array_keys(FinanceLocation::STATUS))],
        ];
    }
